...
AddAlt = Enter ALT text for the image
...
FinishedProcess = Finished processing PSBluesky module data
Following = Now following Bluesky account {0}
FoundCommands = Found {0} functions
GetFollowers = Getting {0} followers for {1}
GetKnownFollowers = Getting {0} known followers for {1}
...
NoSpectreConsole = This command requires the pwshSpectreConsole module. Please install the latest version from the PowerShell Gallery.
...
ProgressActivity1 = Getting all followers
ProgressStatus1 = Retrieving followers...{0}%
ProgressActivity2 = Getting all following accounts
ProgressStatus2 = Retrieving following accounts...{0}%
ProgressActivity3 = Getting all liked posts
ProgressStatus3 = Retrieved...{0}
...
RetrievedFollowers = Retrieved {0} followers
RetrievedFollowing = Retrieved {0} following accounts
...
Unsupported =  {0} objects are currently not supported by this command at this time.
...
UsingSpectre = Using pwshSpectreConsole module version {0}
'@