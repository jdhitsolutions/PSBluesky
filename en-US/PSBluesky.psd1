...
IncompleteList = List contains {0} items but only {1} have been returned. You may need to use -All to return all items. Note: users who have blocked the list creator will not be returned, this may also cause an incomplete list.
